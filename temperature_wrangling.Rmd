...
temp_time_avgs %>% 
  ...
  mutate(Prev_max_C = lag(Max_C), 
         ...
         Max_C_5 = lag(Max_C) + lag(Max_C, 2) + lag(Max_C, 3) + lag(Max_C, 4) + lag(Max_C, 5),
         Max_C_6 = lag(Max_C) + lag(Max_C, 2) + lag(Max_C, 3) + lag(Max_C, 4)+ lag(Max_C, 5) + lag(Max_C, 6),
         Max_C_7 = lag(Max_C) + lag(Max_C, 2) + lag(Max_C, 3) + lag(Max_C, 4) + lag(Max_C, 5) + lag(Max_C, 6) + lag(Max_C, 7),
         ...
         Mean_max_C_4 = Max_C_4/4,
         Mean_max_C_5 = Max_C_5/5,
         Mean_max_C_6 = Max_C_5/6,
         Mean_max_C_7 = Max_C_5/7,
         # add mean temperatures as well
         Prev_mean_C = lag(Mean_C), 
...
```{r}
all_temp %>% 
  dplyr::select(Day, Mean_max_C_4, Mean_C_4, Mean_max_C_5, Mean_max_C_6, Mean_max_C_7) %>% 
