...
arrange_ggsurvplots(list(
  ggsurvplot(c.fit, conf.int = TRUE, legend.labs=c("Yes", "Control"),
             ...
             legend = leg_pos,
             palette = c(skyB, lightO), 
             legend.title = "(a) Crab", conf.int.alpha = 0.1, 
             xlab="Time (days)"),
  ggsurvplot(a.fit, legend.labs=c("Yes", "Control"),
             ggtheme = theme_classic(base_size = fnt_sz), 
             legend = leg_pos,
             palette = c(forGreen , lightO), 
             legend.title = "(c) Algae", conf.int = TRUE, 
             conf.int.alpha=0.1, 
             xlab="Time (days)"),
  ggsurvplot(w.fit, data = surv_df, legend.labs=c("Yes", "Control"),
             ggtheme = theme_classic(base_size = fnt_sz), 
             legend = leg_pos,
             palette = c(darkO, lightO), 
             legend.title = "(b) Wounding", 
             conf.int = TRUE, 
             conf.int.alpha=0.1, 
             xlab="Time (days)"),
