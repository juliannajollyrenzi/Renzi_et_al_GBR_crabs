...
surv_df %>% 
  ...
  ggplot(aes(x = Treatment, y = Delta_time, fill = Algae_treatment, color = Crab_treatment)) +
  geom_boxplot(size = 1) +
  scale_fill_manual(values = alpha(c(skyB, darkO), 0.6)) +
  scale_color_manual(values = c(forGreen, lightO)) +
